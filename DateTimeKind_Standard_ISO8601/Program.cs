...
namespace DateTimeKindPadraoISO8601 {
    class Program {
        static void Main(string[] args) {
            ...
            Console.WriteLine();
            Console.WriteLine(d5.ToString("yyyy-MM-ddTHH:mm:ssZ")); // cuidado está errado, precisar usar ToUniversalTime()
            Console.WriteLine(d5.ToUniversalTime().ToString("yyyy-MM-ddTHH:mm:ssZ"));// forma correta de se fazer.
